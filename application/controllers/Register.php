   ...
   /*  function home()
        ...
        if ($this->form_validation->run()) {
            ...
            if ($id > 0) {
                ...
                $config = array(
                    ...
                    'smtp_port' => 587,
                    'smtp_user' => 'abzansari19@gmail.com', // change it to yours
                    'smtp_pass' => 'Avenger@5015', // change it to yours
                    'mailtype' => 'html',
                    'wordwrap' => TRUE
              );
                ...
                $this->email->from(NOREPLY, 'Theemwix');
    ...
    function verify_email()
    {
        if ($this->uri->segment(3)) {
            ...
            $this->load->view('layouts/email_verification', $data);
        }
    }
